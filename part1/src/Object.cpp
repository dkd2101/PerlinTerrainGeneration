...
void Object::MakeTexturedQuad(std::string fileName){
        ...
        m_geometry.AddVertex( 0.0f,-1.0f, -1.0f, 0.0f, 0.0f);
        m_geometry.AddVertex( 0.0f,-1.0f, 1.0f, 1.0f, 0.0f);
    	m_geometry.AddVertex( 0.0f, 1.0f, 1.0f, 1.0f, 1.0f);
        m_geometry.AddVertex( 0.0f, 1.0f, -1.0f, 0.0f, 1.0f);
        ...
        m_textureFloor.LoadTexture(fileName.c_str());
        m_textureMidLow.LoadTexture(fileName.c_str());
        m_textureMidHigh.LoadTexture(fileName.c_str());
        m_textureTop.LoadTexture(fileName.c_str());
}

void Object::LoadGradientTextures(std::string path1, std::string path2, std::string path3, std::string path4){
        m_textureFloor.LoadTexture(path1.c_str());
        m_textureMidLow.LoadTexture(path2.c_str());
        m_textureMidHigh.LoadTexture(path3.c_str());
        m_textureTop.LoadTexture(path4.c_str());
}
...
void Object::Bind(){
        ...
        m_textureFloor.Bind(1);
        m_textureMidLow.Bind(2);
        m_textureMidHigh.Bind(3);
        m_textureTop.Bind(4);
}
